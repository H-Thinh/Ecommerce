...
CREATE TABLE `Province` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name_province` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `Province_name_province_key`(`name_province`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `ProvinceDistance` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    UNIQUE INDEX `ProvinceDistance_fromProvinceId_toProvinceId_key`(`fromProvinceId`, `toProvinceId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ProvinceDistance` ADD CONSTRAINT `ProvinceDistance_fromProvinceId_fkey` FOREIGN KEY (`fromProvinceId`) REFERENCES `Province`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ProvinceDistance` ADD CONSTRAINT `ProvinceDistance_toProvinceId_fkey` FOREIGN KEY (`toProvinceId`) REFERENCES `Province`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
